...
# st.image("logo.png", caption="PepMine: Mine my pep.")

# Remember to replace "path/to/your/logo_or_image.png" with the actual path to your logo or an image that represents your project.
